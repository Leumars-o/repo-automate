...
class CommitMessageGenerator:
    ...
    SMART_CONTRACT_TEMPLATES = [
        ...
        "Utilized clarity predictable smart contract system to create contract for {project_name}",
    ...
    DOCUMENTATION_TEMPLATES = [
        ...
        "Create detailed README and project documentation",
        "Documented {project_name} contract usage and features",
        "Add project documentation and usage examples",
        "Create {project_name} developer documentation",
        "Documented contract deployment and integration guide",
        "Add comprehensive {project_name} project docs",
        "Create user and developer documentation",
        "Documented {project_name} deployment and usage",
        "Add detailed project README and guides",
        "Create {project_name} technical documentation",
        "Documented contract architecture and design",
        "Add {project_name} integration documentation",
